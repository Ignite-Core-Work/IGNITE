...
const Crew = () => {   
  ...
  const defaultOptions = {
    ...
    const teamMembers = [
        ...
        { name: 'U Rishitha Sharon', role: 'Chief Operating Officer', imageSrc: rishitha }, 
        ...
        { name: 'C Sai Vivek', role: 'Chief Social Officer', imageSrc: saivivek },
        { name: 'P Sai Pavan Kumar', role: 'Chief Finance Officer', imageSrc: saipavan},        
        { name: 'B Srinadh', role: 'Chief Creative Offier', imageSrc: sreenadh},
        { name: 'S Sreedhar', role: 'Chief Marketing Officer', imageSrc: Sridhar },
      ];
